...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Current time, date, timezone → if the latest message carries a "
    "[Current time: ...] line, that line is authoritative; use it rather than "
    "the system clock, which is not the conversation's clock when a "
    "conversation is being replayed. Only if no such line is present, use "
    "terminal (e.g. date).\n"
