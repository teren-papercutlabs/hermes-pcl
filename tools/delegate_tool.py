...
def _run_single_child(
    ...
    **_kwargs,
    ...
    def _touch_parent_delegate_activity() -> bool:
    ...
    def _heartbeat_loop():
        while not _heartbeat_stop.is_set():
            if not _touch_parent_delegate_activity():
                break
    ...
    try:
        # First heartbeat is synchronous so a short or scheduler-delayed child
        # run still refreshes parent activity immediately.
        ...
        try:
            ...
            # Final successful completion touch closes the child-run activity
            # window and removes scheduler jitter from short subagent runs.
            _touch_parent_delegate_activity()
